...
* [#601](https://github.com/provenance-io/cosmos-sdk/pull/601) Provenance: Propagate the event history into the end blocker from v0.50.x to v0.53.x (original PR #601).
