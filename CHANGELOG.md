...
* [#629](https://github.com/provenance-io/cosmos-sdk/pull/629) Provenance: Create the InputOutputCoinsProv function that's similar to InputOutputCoins but allows many inputs with a single output (as well as 1-1 and 1-many still).
