...
var (
	...
	deliverBlockWaitLimit = time.Duration(2000)
)
...
func TestKafkaStreamingService(t *testing.T) {
	...
	kss, err := NewKafkaStreamingService(logger, producerConfig, topicPrefix, flushTimeoutMs, testKeys, testMarshaller, deliverBlockWaitLimit)
