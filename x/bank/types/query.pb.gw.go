...
var (
	...
	pattern_Query_QuarantinedFunds_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "bank", "v1beta1", "quarantined", "funds", "to_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QuarantinedFunds_2 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"cosmos", "bank", "v1beta1", "quarantined", "funds", "to_address", "from_address"}, "", runtime.AssumeColonVerbOpt(false)))
)
